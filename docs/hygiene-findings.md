...
| 11  | A disabled glyph is dropped from a new deck with `Deck created!` and no notice                                                              | minor    | P2-API done, notice in P2-CLIENT | `decksRouter.ts:56-64`                                                                                              | `worker-2/deckcreate-observations.txt`                                                                                                             |
...
Counts. 29 rows: 0 blocker, 11 major, 15 minor, 3 cosmetic. Eighteen are open, assigned
P2-CLIENT 8, P2-FOUND 10, counting row 11 in P2-CLIENT's queue: P2-API closed rows
6 to 10 and row 11's server half, and the learner-facing notice is the client's. Eleven are
closed: rows 1 to 5 by P2-STUDY, each replayed against the fix on lane 6 before it was marked,
rows 6 to 10 by P2-API, and row 26 by P4-HEADERS. Row 26 is already fixed: P4-HEADERS landed a
