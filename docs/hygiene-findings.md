...
| 30  | A dictionary entry that has a memory aid throws React #418 when loaded signed in                                                            | minor    | P5-STATES                     | `vocab-entry.tsx` memory-aid block                                                                                  | `hanzimind-evidence/swarm-P2-CLIENT-2/worker-1/hyd418-signed-in.png`                                                                               |
...
Counts. 31 rows: 0 blocker, 11 major, 17 minor, 3 cosmetic. Thirteen are open: rows 19 to 25 and
27 to 29 for P2-FOUND, row 16 for P3-STUDY-SVC, and rows 30 and 31 for P5-STATES. Eighteen are
closed: rows 1 to 5 by P2-STUDY, rows 6 to 10 by P2-API, rows 11 to 15, 17 and 18 by P2-CLIENT,
and row 26 by P4-HEADERS, which landed a nonce-based `script-src` while the hunt was still in
review.
