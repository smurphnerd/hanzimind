...
Counts. 29 rows: 0 blocker, 11 major, 15 minor, 3 cosmetic. Twenty-three are open, assigned
P2-STUDY 5, P2-CLIENT 8, P2-FOUND 10, counting row 11 in P2-CLIENT's queue: P2-API closed rows
6 to 10 and row 11's server half, and the learner-facing notice is the client's. Six are closed,
rows 6 to 10 here and row 26 by P4-HEADERS. Row 26 is already fixed: P4-HEADERS landed a
